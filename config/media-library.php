...
return [
     ...
     */
    // Buffer 110MB: validasi controller (100MB) yang jadi gatekeeper utama
    // — Spatie sengaja sedikit lebih longgar agar pesan validasi Indonesia yang muncul,
    //   bukan exception FileIsTooBig (Inggris). Multipart overhead juga ter-cover.
    'max_file_size' => 1024 * 1024 * 110, // 110MB
